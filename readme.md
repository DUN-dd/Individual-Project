...
│   │   ├── godot-build/              # Godot build action for CI/CD
...
│   │   │   ├── core/                 # Core autoload systems and managers
...
│   │   │   │   ├── achievement_system.gd         # Player achievements tracking
│   │   │   │   ├── analytics_module.gd           # Analytics and telemetry
...
│   │   │   │   ├── error_reporter.gd             # Centralized error reporting
...
│   │   │   │   └── ...                           # 30+ additional core systems
│   │   │   ├── ui/                   # UI controllers and components (60+ scripts)
...
│   │   │   ├── achievements/         # Achievement badge PNG icons (19 files)
│   │   │   ├── backgrounds/          # Background images (20 files)
│   │   │   ├── characters/           # Character portraits and expressions (63 files)
│   │   │   ├── font/                 # Font files (EN, ZH-CN)
│   │   │   ├── icons/                # UI icons and symbols
│   │   │   ├── music/                # Background music tracks (13 MP3 files)
│   │   │   ├── rebirth_challenge/    # FSM 30-day challenge daily images
│   │   │   │   └── rebirth_day_*.png # Daily challenge artwork (Day 1–8)
│   │   │   ├── sound/                # Sound effects
│   │   │   │   └── gloria/           # Gloria voice lines (en/, zh/)
│   │   │   └── ui/                   # UI textures and graphics
│   │   │       ├── guide_fsm.png     # FSM challenge guide illustration
│   │   │       └── intro/            # Intro story page images (41 PNG files)
...
│   │   ├── gda1_server.py            # Python MCP server implementation
...
│
├── 2.Report/                         # Academic project reports
│
...
Contains 70+ scripts (48 root-level autoloads + 26 in `ai/` + 4 in `agent/`) that form the game's backbone:
- **AI System**: Multi-provider AI integration (OpenAI, Anthropic, Ollama) with request management, context building, safety filtering, and voice synthesis
- **Agent System**: MCP (Model Context Protocol) server for external AI agent interaction
- **State Management**: Game state, player stats, mission progress, session tracking
- **Asset Management**: Asset registry, background loader, character expression loader, font manager
- **Event Systems**: EventBus for cross-module communication, butterfly effect tracking
- **Save/Load**: Comprehensive save system with JSON serialization
- **UI Systems**: Notification system, tutorial system, UI debug overlay
- **Audio**: Music and sound effect management with pooling

### UI Controllers (`1.Codebase/src/scripts/ui/`)
69 UI controller scripts following the controller pattern:
...
Structured prompts and instructions for AI agents to generate context-aware game content. Each skill folder contains markdown files that guide the AI in creating narratives, consequences, and game mechanics that align with the game's thematic framework.
