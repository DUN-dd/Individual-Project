...
## Owns all runtime state for the AI-Log tab and handles its button events.
##
## Usage:
##   var ctrl := SettingsMenuAILogController.new()
##   ctrl.initialize(build_result, chart_width, chart_height, tab_container, tr_fn)
##   # Then pass ctrl's callables when calling SettingsMenuAILogSectionScript.build_log_page:
##   {
##       "toggle_log":            Callable(ctrl, "_on_ai_log_toggle_log_pressed"),
##       "toggle_charts":         Callable(ctrl, "_on_ai_log_toggle_charts_pressed"),
##       "refresh":               Callable(ctrl, "_on_ai_log_refresh_pressed"),
##       "export_json":           Callable(ctrl, "_on_ai_export_pressed"),
##       "export_csv":            Callable(ctrl, "_on_ai_export_csv_pressed"),
##       "clear":                 Callable(ctrl, "_on_ai_log_clear_pressed"),
##       "chart_size_changed":    Callable(ctrl, "_on_ai_chart_size_changed"),
##       "chart_visibility_toggled": Callable(ctrl, "_on_ai_chart_visibility_toggled"),
##       "tab_changed":           Callable(ctrl, "_on_ai_log_tab_changed"),
##   }
...
# ── Dependencies ──────────────────────────────────────────────────────────────
var _tab_container: TabContainer = null  # needed for tab-index checks
var _tr_fn: Callable                      # (key: String, fallback: String) -> String

## Wires up all node references returned by SettingsMenuAILogSectionScript.build_log_page.
func initialize(
	result: Dictionary,
	chart_width: float,
	chart_height: float,
