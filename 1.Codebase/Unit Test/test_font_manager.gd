...
func _test_font_variation_validation() -> void:
	...
	assert(FontManager.get_safe_font(variation) == FontManager.FALLBACK_FONT, "FontVariation without base font should fall back")
	variation.base_font = FontManager.FALLBACK_FONT
	assert(FontManager.get_safe_font(variation) == variation, "FontVariation with valid base font should be accepted")
